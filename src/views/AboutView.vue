<template>
  <main>
    ...
    <div class="socials">
      <a
        class="social-link uses-dynamic github"
        href="https://github.com/Mini-Sylar"
        target="_blank"
        title="check out more of my projects on github"
        @click="$mixpanel.track('Visited Github')"
      >
        <svg
          class="social-link uses-dynamic"
      ...
      ></a>
      <a
        class="social-link uses-dynamic twitter"
        href="https://twitter.com/Mini_Sylar"
        target="_blank"
        title="reach out to me on twitter"
        @click="$mixpanel.track('Visited Twitter')"
      >
        <svg
          class="social-link uses-dynamic"
          xmlns="http://www.w3.org/2000/svg"
...
useHead({
  title:
    route.currentRoute.value.path === "/about"
      ? "Anime Info Platform | About"
      : "Anime Info Platform | Contact",
  meta: [
    {
      name: "description",
      content:
        "About and contact page for the website of the anime fan and developer, Mini Sylar.",
    },
    {
      name: "keywords",
      content:
        "about, contact, anime, mini sylar, sylar, sylar mini, sylar mini anime, sylar mini anime website, sylar mini anime fan, sylar mini anime developer, sylar mini anime fan website, sylar mini anime developer website, sylar mini anime fan",
    },
  ],
});
</script>
