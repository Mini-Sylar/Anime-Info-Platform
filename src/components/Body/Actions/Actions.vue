  ...
  <div>
    <div class="actions-container" v-on-click-outside="hideWhenClickedOutside">
      <div class="Starred">
        <button
          @click="starShow"
          :title="isStarred ? 'Unstar Show' : 'Star Show'"
          :class="[
            isStarred == true ? 'star-show-container starred' : 'star-show-container unstarred'
          ]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            class="star-button star-icon"
          >
            <path
      ...
      <div class="share">
        <button
          type="button"
          class="action-button share-main"
          title="Share show"
          @click="useShareAnime"
        >
        ...
        <button
          type="button"
          class="action-button history-show"
          title="View History"
        ...
        <button
          ...
          title="show bookmarked anime"
          @click="showMiniBookmarkMenu"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40px"
